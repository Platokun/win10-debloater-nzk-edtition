...
#NZK changed & to + because on menu it does _FIXES instead of "& FIXES"
$Other.AutoSize                  = $true
$Other.width                     = 457
$Other.height                    = 172
...
$OtherPanel.controls.AddRange(@($Other,$RemoveOnedrive,$InstallNet35,$UnpinStartMenuTiles,$DisableTelemetry,$RemoveRegkeys,$UninstallButton))
#nzk
#$Form.Controls.Add()
